...
while($row = mysqli_fetch_array($result)) {
    ...
    echo "<td style='width:35%'  align='center'><input type='submit' id='delete_club_btn". $row['id'] ."' value='Delete' onclick='delete_club(". $row['id'] .");   style='width:40%''>
	<input type='submit' id='edit_club_btn". $row['id'] ."' value='Edit' onclick='edit_club(". $row['id'] .", ". $row['id'] .");'   style='width:40%'> ";
    echo "</tr>";
}
echo "</table>";
?>
