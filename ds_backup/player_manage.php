<meta charset="UTF-8">
  <link href="player_manage.css" rel="stylesheet" type="text/css">
<div id="player_container">
  <div id="club_left_div">
...
while($row = mysqli_fetch_array($result)) {
    echo "<tr>";
    echo "<td style='width:15%'  align='center' >".$row['id']."</td>";
	...
	echo "<td style='width:15%'  align='center'><input id='captain". $row['id'] ."' type='text' value='". $row['credibility'] ."'  disabled=true   style='width:50%' class='player_input_list'></td>";
    echo "<td style='width:35%'  align='center'><input type='submit' id='delete_club_btn". $row['id'] ."' value='Delete' onclick='delete_club(". $row['id'] .");'   style='width:45%'>
	<input type='submit' id='edit_club_btn". $row['id'] ."' value='Edit' onclick='edit_club(". $row['id'] .", ". $row['id'] .");'   style='width:35%'> ";
    echo "</tr>";
}
echo "</table>";
?>
  </div>
  <div id="player_right_div">
